...
parser.add_argument('--augment_mode', help='How to augment data with biased labels', choices=['none', 'basic', 'clipped', 'noise', 'noise_weak', 'noise_minor', 'other_colors', 'strips'], default='none')
